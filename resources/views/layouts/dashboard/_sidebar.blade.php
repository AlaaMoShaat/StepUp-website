<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-users"></i><span class="menu-title"
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ isActiveRoute('dashboard.roles.create') }}"><a class="menu-item"
                                ...
                                data-i18n="nav.templates.vert.main">{{ __('static.role.create_role') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan
            ...
            @can('stores')
                <li class=" nav-item"><a href="#"><i class="la la-user"></i><span class="menu-title"
                            data-i18n="nav.templates.main">{{ __('static.stores.title') }}</span>
                        <span class="main-badge badge badge-pill badge-warning">{{ $stores_count }}</span>
                    </a>
                    <ul class="menu-content">

                        <li class="{{ isActiveRoute('dashboard.stores.index') }}"><a class="menu-item"
                                href="{{ route('dashboard.stores.index') }}"
                                data-i18n="nav.templates.vert.main">{{ __('static.stores.title') }}</a>
                        </li>
                        <li class="{{ isActiveRoute('dashboard.stores.create') }}"><a class="menu-item"
                                href="{{ route('dashboard.stores.create') }}"
                                data-i18n="nav.templates.vert.main">{{ __('static.stores.create_store') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan
            ...
            @can('settings')
                <li class="{{ isActiveRoute('dashboard.settings.index') }} nav-item"><a
                        href="{{ route('dashboard.settings.index') }}"><i class="la la-cogs"></i><span class="menu-title"
            ...
            {{-- @can('sliders')
                <li class="nav-item"><a href=""><i class="la la-cogs"></i><span class="menu-title"
                            data-i18n="nav.templates.main">{{ __('static.sliders.title') }}</span>
                        <span class="main-badge badge badge-pill badge-warning">{{ $sliders_count }}</span>
                    </a>
                </li>
            @endcan --}}
